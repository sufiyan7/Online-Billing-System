         ...
         <div class="col-md-12">
           ...
           <div class="table-responsive">
             ...
             <table align="center" class="table table-bordred table-striped">
               ...
               <tbody>
                   <?php
                $sql_query="SELECT raw_materials.id, raw_materials.title, raw_materials.unit, raw_materials.price, total.status, total.quantity, total.total_price FROM `raw_materials` left join total on raw_materials.id=total.raw_id";
             ...
             <!-- <a class="btn btn-danger btn-sm" href="reset_table1.php" role="button">Reset</a> -->
